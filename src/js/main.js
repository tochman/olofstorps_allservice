...
class App {
  constructor() {
    this.config = {
      googleMapsApiKey:
        import.meta.env.VITE_GOOGLE_MAPS_API_KEY || 'AIzaSyC4slvWy8btLEoMcdrtVw0T3ZPX47vunN4',
  ...
  async loadProjectTemplates() {
    ...
    try {
      for (const project of projects) {
        await templateEngine.loadAndRender(project.name, project.path, {}, project.target);
      }
